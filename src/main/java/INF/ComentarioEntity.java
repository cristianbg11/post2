...
@Entity
@Table(name = "COMENTARIO", schema = "PUBLIC", catalog = "PRACTICA4E")
public class ComentarioEntity {
    ...
    public List<LikeComentarioEntity> likeComentariosById;
    public int cantLikes = 0;
    public int cantDisLikes = 0;
    ...
    public List<LikeComentarioEntity> getLikeComentariosById() {
        return likeComentariosById;
    }

    public void setLikeComentariosById(List<LikeComentarioEntity> likeComentariosById) {
